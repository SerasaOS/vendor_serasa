...
if __name__ == '__main__':
    # Default to serasa Gerrit
    default_gerrit = 'https://review.serasa-os.org'

    parser = argparse.ArgumentParser(formatter_class=argparse.RawDescriptionHelpFormatter, description=textwrap.dedent('''\
        repopick.py is a utility to simplify the process of cherry picking
        patches from serasa's Gerrit instance (or any gerrit instance of your choosing)
    ...
    for change in change_numbers:
        ...
        mergables.append({
            ...
            'project': review['project'].replace("Serasa-Rom/", ""),
    ...
    for item in mergables:
        ...
        project_path = None
        item['project'].replace("Serasa-Rom/", "")
