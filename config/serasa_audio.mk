...
ALARM_PATH := vendor/serasa/prebuilt/common/media/audio/alarms
NOTIFICATION_PATH := vendor/serasa/prebuilt/common/media/audio/notifications
RINGTONE_PATH := vendor/serasa/prebuilt/common/media/audio/ringtones
...
PRODUCT_COPY_FILES += \
    ...
    $(NOTIFICATION_PATH)/no-pro.ogg:$(TARGET_COPY_OUT_PRODUCT)/media/audio/notifications/no-pro.ogg \
...
PRODUCT_COPY_FILES += \
    ...
    $(RINGTONE_PATH)/NewSongette.ogg:$(TARGET_COPY_OUT_PRODUCT)/media/audio/ringtones/NewSongette.ogg \
