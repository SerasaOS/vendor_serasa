...
ADBLOCK_SCRIPT := vendor/serasa/adaway/generate.py

TARGET_GENERATED_HOSTS_BLOCKER := $(TARGET_OUT_INTERMEDIATES)/ADBLOCK/hosts.serasa_adblock
...
include $(CLEAR_VARS)
LOCAL_MODULE := hosts.serasa_adblock
